...
class ZonesTest(BaseZonesTest):
    ...
    def test_update_zone_serial_to_unixtime(self):
        ...
        LOG.info('Update the zone')
        _, zone = self.client.update_zone(zone['id'], description="New description")
...
class ZoneOwnershipTest(BaseZonesTest):
    ...
    def test_no_create_duplicate_domain(self):
        ...
        self.assertRaises(lib_exc.Conflict, self.alt_client.create_zone, name=zone['name'])
    ...
    def test_no_create_superdomain_by_alt_user(self):
        zone_name = dns_data_utils.rand_zone_name(prefix='testdomain')
